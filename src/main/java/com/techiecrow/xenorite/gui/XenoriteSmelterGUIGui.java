...
package com.techiecrow.xenorite.gui;
...
public class XenoriteSmelterGUIGui extends XenoriteModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public XenoriteSmelterGUIGui(XenoriteModElements instance) {
		super(instance, 6);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("xenorite_smelter_gui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				XenoriteMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Xenorite Smelter", 7, 2, -16777216);
			this.font.drawString("Fuel", 7, 29, -16777216);
			this.font.drawString("Ingots", 61, 29, -16777216);
			this.font.drawString("Output", 133, 29, -16777216);
		}
