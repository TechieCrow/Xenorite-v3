...
public class XenoriteSmelterGUIScreen extends AbstractContainerScreen<XenoriteSmelterGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Xenorite Smelter", 6, 6, -16777216);
		this.font.draw(poseStack, "Fuel", 6, 29, -16777216);
		this.font.draw(poseStack, "Ingots", 57, 28, -16777216);
		this.font.draw(poseStack, "Output", 125, 29, -16777216);
	}
