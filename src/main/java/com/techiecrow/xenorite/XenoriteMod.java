 ...
 *
 */
package com.techiecrow.xenorite;
...
@Mod("xenorite")
public class XenoriteMod {
	public static final Logger LOGGER = LogManager.getLogger(XenoriteMod.class);
	public static final String MODID = "xenorite";
