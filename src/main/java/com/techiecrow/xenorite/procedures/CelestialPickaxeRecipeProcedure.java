...
public class CelestialPickaxeRecipeProcedure {
	public static void execute(Entity entity) {
		...
		if (new Object() {
			public int getAmount(int sltid) {
				...
				.getItem() == XenoriteModItems.CELESTIAL_INGOT.get() && new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
								&& _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
				...
				&& (entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr
						...
						.getItem() == XenoriteModItems.CELESTIAL_INGOT.get()
				&& new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
								&& _current.get() instanceof Map _slots) {
			...
			if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
					&& _current.get() instanceof Map _slots) {
				ItemStack _setstack = new ItemStack(XenoriteModItems.CELESTIAL_PICKAXE.get());
