...
public class CoreoriteShovelItem extends XenoriteModElements.ModElement {
	@ObjectHolder("xenorite:coreorite_shovel")
	public static final Item block = null;
	public CoreoriteShovelItem(XenoriteModElements instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("coreorite_shovel"));
	}
}
