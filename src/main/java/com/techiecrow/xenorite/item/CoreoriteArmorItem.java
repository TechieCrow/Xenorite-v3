...
public class CoreoriteArmorItem extends XenoriteModElements.ModElement {
	@ObjectHolder("xenorite:coreorite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("xenorite:coreorite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("xenorite:coreorite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("xenorite:coreorite_armor_boots")
	public static final Item boots = null;
	public CoreoriteArmorItem(XenoriteModElements instance) {
		super(instance, 63);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(XenoriteCreativeTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "xenorite:textures/models/armor/coreorite__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("coreorite_armor_helmet"));
		elements.items
				...
				}.setRegistryName("coreorite_armor_chestplate"));
		...
		}.setRegistryName("coreorite_armor_leggings"));
		...
		}.setRegistryName("coreorite_armor_boots"));
	}
}
