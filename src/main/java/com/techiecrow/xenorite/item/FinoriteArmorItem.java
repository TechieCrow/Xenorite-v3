...
public abstract class FinoriteArmorItem extends ArmorItem {
	public FinoriteArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends FinoriteArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "xenorite:textures/models/armor/finorite__layer_1.png";
		}
	}

	public static class Chestplate extends FinoriteArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends FinoriteArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "xenorite:textures/models/armor/finorite__layer_2.png";
		}
	}

	public static class Boots extends FinoriteArmorItem {
		public Boots() {
