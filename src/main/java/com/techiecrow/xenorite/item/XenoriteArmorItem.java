...
public abstract class XenoriteArmorItem extends ArmorItem {
	public XenoriteArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends XenoriteArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "xenorite:textures/models/armor/xenorite__layer_1.png";
		}
	}

	public static class Chestplate extends XenoriteArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends XenoriteArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "xenorite:textures/models/armor/xenorite__layer_2.png";
		}
	}

	public static class Boots extends XenoriteArmorItem {
		public Boots() {
