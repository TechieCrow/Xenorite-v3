...
public class XenoriteSmelterBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public XenoriteSmelterBlockEntity(BlockPos position, BlockState state) {
		super(XenoriteModBlockEntities.XENORITE_SMELTER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("xenorite_smelter");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new XenoriteSmelterGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
